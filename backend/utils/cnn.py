...
#     resized_image = cv2.resize(character_image, (32, 32))
...
#     model_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'notebook', 'no_dropout.keras'))
#     print(model_path)
#     # /home/zephyr/Desktop/.code/college/alnpr/notebook/no_dropout.keras
